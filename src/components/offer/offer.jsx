...
class Offer extends PureComponent {
  ...
  render() {
    const {offers, onMainClick} = this.props;

    const {pictures, premium, title, rating, type, bedrooms, guests, price, households, owner, comments} = offers;
                      ...
                      <li className="reviews__item" key={`review-${i}`}>
                        <div className="reviews__user user">
                          <div className="reviews__avatar-wrapper user__avatar-wrapper">
                            <img className="reviews__avatar user__avatar" src={item.guest.avatar} width="54" height="54" alt="Reviews avatar" />
                          </div>
